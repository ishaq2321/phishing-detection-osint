...
can reuse its existing result rendering.  Successful ingests are
...
framework, comprising 1113 distinct tests (944 backend \texttt{pytest} unit/integration tests, 139 frontend \texttt{Jest} tests, and 30 \texttt{Playwright} E2E browser tests) distributed
