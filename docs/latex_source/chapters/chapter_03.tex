...
framework, comprising 1057 distinct tests (890 backend \texttt{pytest} unit/integration tests, 139 frontend \texttt{Jest} tests, and 28 \texttt{Playwright} E2E browser tests) distributed
