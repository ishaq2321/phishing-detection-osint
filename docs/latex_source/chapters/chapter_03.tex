...
framework, comprising 1141 distinct tests (965 backend \texttt{pytest} unit/integration tests, 145 frontend \texttt{Jest} tests, and 31 \texttt{Playwright} E2E browser tests) distributed
