...
framework, comprising 1093 distinct tests (924 backend \texttt{pytest} unit/integration tests, 139 frontend \texttt{Jest} tests, and 30 \texttt{Playwright} E2E browser tests) distributed
