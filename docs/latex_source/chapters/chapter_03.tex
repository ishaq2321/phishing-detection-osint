...
framework, comprising 754 distinct tests (593 backend \texttt{pytest} unit/integration tests, 133 frontend \texttt{Jest} tests, and 28 E2E \texttt{Cypress} tests) distributed
